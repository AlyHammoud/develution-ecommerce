  ...
  <div class="about-us">
    <div class="top">
      ...
      <div class="curve">
        ...
        <p>{{ store.getGeneralInfos.company_name }}</p>
      </div>
    </div>
    ...
    <div class="bottom">
      <div class="moto">
        <h2>About Us</h2>
        <p>
          {{ store.getGeneralInfos.moto }}
        </p>
      </div>
      <img
        v-if="!store.getGeneralInfos.company_simage"
        src="/images/empty.png"
        alt=""
      />
      <img :src="store.getGeneralInfos.company_simage" v-else alt="" />
    </div>
  </div>
</template>
<script setup>
